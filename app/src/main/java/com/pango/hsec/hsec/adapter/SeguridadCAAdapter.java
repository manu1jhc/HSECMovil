...
public class SeguridadCAAdapter extends ArrayAdapter<PublicacionModel> {
    private Context context;
    View popupView;
    public PopupWindow popupWindow;
    FragmentSecuridadCA fragmentMuro;
    private ArrayList<PublicacionModel> data = new ArrayList<PublicacionModel>();
    DateFormat formatoInicial = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
    DateFormat formatoRender = new SimpleDateFormat("EEEE d 'de' MMMM 'de' yyyy");

    public SeguridadCAAdapter(Context context, ArrayList<PublicacionModel> data,FragmentSecuridadCA fragmentMuro) {
        super(context, R.layout.public_seguridad_ca, data);
        this.data = data;
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.public_seguridad_ca, null, true);
        ...
        btn_editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button1.setText("  Editar Seguridad - CA");
                button3.setText("  Eliminar Seguridad - CA");
                if(edit.equals("1")){
                ...
                button1.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View v){
                        ...
                        GlobalVariables.ObjectEditable=true;
                        Intent intent = new Intent(getContext(), ActIngresoSeg.class);
