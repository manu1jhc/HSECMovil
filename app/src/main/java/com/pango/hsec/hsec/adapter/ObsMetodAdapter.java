...
public class ObsMetodAdapter extends RecyclerView.Adapter<ObsMetodAdapter.ViewHolder> {
    ...
    public ObsMetodAdapter(Activity activity, List<SubDetalleModel> items) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        if(em.CodTipo.equals("OBSR")){
            viewHolder.det_gestion.setText(GlobalVariables.getDescripcion(GlobalVariables.GestionRiesg_obs, em.Descripcion));
