...
import com.pango.hsec.hsec.ui.PickerActivity;
...
public final class Picker {
    ...
    public static class Builder {
        ...
        public Builder setFabBackgroundColor(@ColorInt final int color) {
            mFabBackgroundColor = color;
            return this;
        }

        public Builder setFabBackgroundColorWhenPressed(@ColorInt final int color) {
            mFabBackgroundColorWhenPressed = color;
            return this;
        }

        public Builder setImageBackgroundColorWhenChecked(@ColorInt final int color) {
            mImageBackgroundColorWhenChecked = color;
            return this;
        }

        public Builder setImageBackgroundColor(@ColorInt final int color) {
            mImageBackgroundColor = color;
            return this;
        }

        public Builder setImageCheckColor(@ColorInt final int color) {
            mImageCheckColor = color;
            return this;
        }

        public Builder setCheckedImageOverlayColor(@ColorInt final int color) {
            mCheckedImageOverlayColor = color;
            return this;
        }


        public Builder setAlbumBackgroundColor(@ColorInt final int color) {
            mAlbumBackgroundColor = color;
            return this;
        }

        public Builder setAlbumNameTextColor(@ColorInt final int color) {
            mAlbumNameTextColor = color;
            return this;
        }

        public Builder setAlbumImagesCountTextColor(@ColorInt final int color) {
            mAlbumImagesCountTextColor = color;
            return this;
        }

        public Builder setPickMode(final PickMode pickMode) {
            mPickMode = pickMode;
            return this;
        }

        public Builder setToolbarPopupTheme(@StyleRes final int themeRes) {
            mPopupThemeResId = themeRes;
            return this;
        }

        public Builder setDoneFabIconTintColor(@ColorInt final int color) {
            mDoneFabIconTintColor = color;
            return this;
        }

        public Builder setCaptureItemIconTintColor(@ColorInt final int color) {
        ...
        public Builder setCheckIconTintColor(@ColorInt final int color) {
            mCheckIconTintColor = color;
            return this;
        }

        public Builder setBackBtnInMainActivity(final boolean backBtn) {
            mBackBtnInMainActivity = backBtn;
            return this;
        }

        public Builder setVideosEnabled(final boolean enabled) {
            mVideosEnabled = enabled;
            return this;
        }

        public Builder setVideoLengthLimitInMilliSeconds(final int limit) {
            mVideoLengthLimit = limit;
            return this;
        }

        public Builder setVideoThumbnailOverlayColor(@ColorInt final int color) {
            mVideoThumbnailOverlayColor = color;
            return this;
        }

        public Builder setVideoIconTintColor(@ColorInt final int color) {
