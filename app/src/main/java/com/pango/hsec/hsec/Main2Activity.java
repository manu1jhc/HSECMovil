...
public class Main2Activity extends AppCompatActivity implements Picker.PickListener {
    ...
    private void showAbout() {
        ...
        progressDialog.setTitle(R.string.about_title);
        progressDialog.setMessage(aboutBody);
